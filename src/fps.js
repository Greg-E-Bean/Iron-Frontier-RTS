...
function fpsShoot(e){if(e.cool>0)return;const t=e.d,n=Math.cos(FPS.yaw),a=Math.sin(FPS.yaw),r=1.05*(t.range||120)*(FPS.aiming?1.2:1),o=fpsAimTarget(e);FPS.viewKick=Math.min(.09,(FPS.viewKick||0)+.028),o&&(FPS.hitFlashT=.15),o?(e.cool=t.rof*vRof(e),"mind"!==t.role?fire(e,o,t):mindTick(e,o)):"mind"!==t.role&&t.dmg>0&&(e.cool=t.rof*vRof(e),fire(e,{x:e.x+n*r,y:e.y+a*r,e:"u",d:{armor:"veh"},dead:!1},t))}
