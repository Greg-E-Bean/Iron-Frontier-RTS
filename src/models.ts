...
const cx=c[0]*.3*r,cy=c[1]*.3*r;
n.push(P_(CYL(.06*r,.24*r,10),cx,cy,z2,"concrete2"));
n.push(P_(CYL(.08*r,.05*r,10),cx,cy,z2+.24*r,"armor2"));
n.push(P_(CYL(.02*r,.05*r,8),cx,cy,z2+.29*r,"red",{e:1,a:{spin:1.4}}));
}
}else{
hive(n,{x:0,y:0,z:l,r:.3*r,h:1.05*s,crown:.17*r,seg:10,spines:1,pods:5,crest:!0,vein:"psi"});
for(const c of[[-1,-1],[1,1],[-1,1]]){
hive(n,{x:c[0]*.32*r,y:c[1]*.3*r,z:l,r:.09*r,h:.3*s,crown:.05*r,seg:7,crest:!1,vein:"psi"});
}
