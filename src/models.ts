...
const e=[];
e.push(P_(CYL(4.4,20,14),0,0,10,"body",{ty:-PI2}));
e.push(P_(DOME(4.4,4.4,12),10,0,10,"body",{ty:-PI2}));
e.push(P_(DOME(4.4,3.8,10),-10,0,10,"dark2",{ty:PI2}));
e.push(P_(CYL(2.6,9,10),-17,0,10.3,"dark2",{ty:-PI2}));
e.push(P_(DOME(4,3.4,10),14,0,11,"glass",{e:1}));
e.push(P_(BOXM(1.8,1,7,.2),-22,0,13,"dark"));
e.push(P_(CYL(1.2,6,8),1,0,15,"gunmetal",{ty:-PI2,e:0}));
e.push(P_(CYL(.8,4,6),-22,0,12,"gunmetal",{ty:-PI2}));
for(const s of[-1,1])e.push(P_(CYL(2.2,11,9),-2,s*7,7,"gunmetal",{ty:-PI2})),e.push(P_(DOME(2.2,2.2,8),3.5,s*7,7,"darkmetal",{ty:-PI2}));
return e;
}
function gulletModel(){
const e=[];
e.push(P_(DOME(6,4.4,12),3,0,10,"carapace2"));
e.push(P_(CONE(4.4,1.6,15,12),-8,0,10,"carapace2",{ty:-PI2}));
e.push(P_(DOME(3.6,3,10),12.5,0,10.5,"carapace"));
e.push(P_(DOME(2.2,1.8,9),15,0,11,"psi",{e:1}));
e.push(P_(DOME(1,.8,8),-15,0,10,"psi",{e:1}));
for(const s of[-1,1])e.push(P_(CONE(1.6,.3,7.5,8),-3,s*5.6,8,"carapace2",{ty:-PI2}));
