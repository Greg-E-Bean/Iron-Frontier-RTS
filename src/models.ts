...
e.push(P_(DOME(4.2,4,12),6,0,FZ,"body",{ty:PI2}));
e.push(P_(DOME(3.6,3.4,10),-10,0,FZ,"dark2",{ty:-PI2}));
e.push(P_(CYL(2.4,9,10),-13.4,0,FZ+.3,"dark2",{ty:-PI2}));
e.push(P_(DOME(3.2,2.8,10),6,0,FZ+2,"glass",{e:1,ty:PI2}));
e.push(P_(BOXM(1.6,1,7,.2),-22,0,FZ-1,"dark"));
e.push(P_(CYL(1.2,6,8),1,0,FZ+4,"gunmetal"));
e.push(P_(CYL(.7,6,6),-22,0,FZ+5,"gunmetal",{ty:-PI2}));
for(const s of[-1,1]){
e.push(P_(CYL(2,10,9),-4,s*7,FZ-2,"gunmetal",{ty:PI2}));
e.push(P_(DOME(2,2,8),6,s*7,FZ-2,"darkmetal",{ty:PI2}));
}
return e;
}
function gulletModel(){
const e=[];
...
a.push(P_(CONE(rad,.25*rad,.2*e,10),0,0,rad,org?"carapace2":"dark",{ty:PI2}));
a.push(P_(CONE(rad,.15*rad,.16*e,10),-.86*e,0,rad,org?"carapace2":"dark",{ty:-PI2}));
...
function droneModel(e){const t=[];t.push(P_(DOME(3.4,2.6,10),0,0,3.4,"carapace2")),t.push(P_(DOME(1.8,1.4,8),0,0,5.6,"carapace")),t.push(P_(DOME(.9,.7,8),0,0,6.9,"psi",{e:1}));for(let i=0;i<4;i++){const a=i*PI2+.6;t.push(P_(CYL(.35,3.6,6),3.1*Math.cos(a),3.1*Math.sin(a),2.4,"carapace2",{r:a,ty:.6})),t.push(P_(DOME(.5,.4,6),4.8*Math.cos(a),4.8*Math.sin(a),.6,"carapace",{e:0}))}return t}function bastionModel(e,fac){const t=[],r=40,n=16;trackUnit(t,r,n,9,e,{trkW:8,wheels:6});t.push(P_(SLAB(hullProfile(.9*r,n+2,fac),6.5,1.8,"bstH"+(fac||"")),0,0,5,"armor2"));
if("soviet"===fac){
t.push(P_(BOXM(1.2*r,13,8,.4),0,0,11,"concrete2"));
for(const s of[-1,1])t.push(P_(CYL(2.6,4,10),0,s*3.8,19,"darkmetal"));
t.push(P_(CYL(4.2,5,12),0,0,19,"gunmetal"));
t.push(P_(CYL(1.6,16,10),20,0,21,"darkmetal",{ty:PI2}));
t.push(P_(CYL(1.6,1.8,8),0,0,24,"rust",{e:1}));
}else if("yuri"===fac){
t.push(P_(DOME(9,7,14),0,0,11,"carapace2"));
for(let i=0;i<5;i++){const a=i*PI2/5+.3;t.push(P_(CONE(1.9,.25,5.5,7),4.3*Math.cos(a),4.3*Math.sin(a),16,"carapace"))}
t.push(P_(DOME(2.8,2.6,10),0,0,18,"psi",{e:1,a:{spin:.6}}));
}else{
t.push(P_(BOXM(1.3*r,10,7,.2),0,0,11,"armor3"));
t.push(P_(CYL(3,10,10),-14,0,13,"gunmetal",{ty:PI2})),t.push(P_(CYL(3,10,10),14,0,13,"gunmetal",{ty:PI2}));
t.push(P_(CYL(4,6,10),0,0,14,"armor")),t.push(P_(DOME(2.4,2,10),0,0,17.5,"glass",{e:1})),t.push(P_(CYL(1,1.4,10),0,0,17,"tesla",{e:1}));
}
return t}function mcvModel(e,fac){const t=[],len=44,wid=22;trackUnit(t,len,wid,11,e,{trkW:9,wheels:6});const hw=.5*(wid+4);t.push(P_(SLAB(hullProfile(.9*len,wid+4,fac),7.5,2.2,"mcvH"+(fac||"")),0,0,6,"armor2"));t.push(P_(BOXM(.5*len,.86*(wid+4),7.5,.6),-4,0,13.5,"armor"));if("soviet"===fac){t.push(P_(BOXM(.4*len,.72*(wid+4),4.8,.5),-4,0,19.8,"concrete2"));t.push(P_(BOXM(.26*len,.56*(wid+4),3.2,.4),-4,0,23.8,"armor3"));for(const sgn of[-1,1])t.push(P_(CYL(1.8,6,10),-.28*len,sgn*.3*hw,27,"rust")),t.push(P_(CYL(2.1,1.2,10),-.28*len,sgn*.3*hw,33,"darkmetal"));t.push(P_(BOXM(2.4,2.4,16,.3),.3*len,.55*hw,11,"gunmetal",{ty:1.1}));t.push(P_(BOXM(2.2,2.2,2,.3),.44*len,.55*hw,24,"darkmetal"));t.push(P_(CYL(1.6,4.5,10),.3*len,-.55*hw,14,"darkmetal"));t.push(P_(CYL(1.8,1.1,10),.3*len,-.55*hw,19,"gold"));hazard(t,-4,-.72*hw,4.5,.5*len,0);bolts(t,-4,-.6*hw,14,.5*len,0,7,"steel");bolts(t,-4,.6*hw,14,.5*len,0,7,"steel")}else if("yuri"===fac){t.push(P_(DOME(.28*len,6,14),-4,0,20,"carapace2"));t.push(P_(DOME(.16*len,3.6,12),-4,0,26,"carapace"));t.push(P_(DOME(3.2,2.8,10),-4,0,29.6,"psi",{e:1,a:{spin:.5}}));for(let i=0;i<4;i++){const ang=i*PI2/2+.4;t.push(P_(CONE(1.6,.2,7,7),-4+6*Math.cos(ang),6*Math.sin(ang),18,"carapace2",{r:ang}))}t.push(P_(CYL(.7,10,6),.32*len,.55*hw,13,"dark2",{ty:PI2,r:.3}));t.push(P_(DOME(1.4,1.1,8),.32*len+9.5,.55*hw+2.8,13,"bile",{e:1}))}else{t.push(P_(DOME(.24*len,5.5,14),-4,0,20,"armor3"));t.push(P_(DOME(4,3.4,12),-4,0,25.5,"glass",{e:1}));t.push(P_(CYL(.55,7,8),-4,0,29,"tesla",{e:1}));for(const sgn of[-1,1])t.push(P_(CYL(.42,8,6),-4+2.6*sgn,sgn*.55*hw,20,"darkmetal",{r:sgn*.22}));t.push(P_(CYL(1.5,4.5,10),.3*len,-.55*hw,14,"darkmetal"));t.push(P_(CYL(1.7,1,10),.3*len,-.55*hw,19,"tesla",{e:1}));seams(t,.4*len,.7*hw,20,"dark")}t.push(P_(CYL(1.2,1.6,8),.34*len,.55*hw+2,7,"lightY",{e:1}));t.push(P_(CYL(1.2,1.6,8),.34*len,-.55*hw-2,7,"lightY",{e:1}));return scaleN(t,1.7)}function weaponRig(e,t,r,n,a){const o=7.4+r,s=-2.1;return"none"===t?(e.push(P_(BOXM(3.2,2,2.4,.6),2,s,5.6+r,"gold")),void e.push(P_(CYL(.4,2.2,6),2,s,8+r,"darkmetal"))):"launcher"===t?(e.push(P_(CYL(1.05,8.4,9),.4,s,o+1.5,"gunmetal",{ty:PI2})),e.push(P_(CYL(1.35,1.6,9),8.2,s,o+1.5,"darkmetal",{ty:PI2})),e.push(P_(BOXM(1.6,1.1,1.2,.3),3,s-.8,o+2.9,"steel")),e.push(P_(BOXM(.5,.5,.9,.15),.6,s-1.3,o+.6,"darkmetal")),void e.push(P_(CYL(.32,1.4,7),-1.6,s-.6,o-2.4,"dark2",{ty:PI2}))):"rocket"===t?(e.push(P_(CYL(1.15,9.4,9),1.8,s-.2,o+5.4,"gunmetal",{ty:PI2})),e.push(P_(CYL(1.5,1.7,9),10.2,s-.2,o+5.4,"darkmetal",{ty:PI2})),e.push(P_(CYL(1,1.1,8),-5.2,s-.2,o+5.4,"steel",{ty:PI2})),e.push(P_(BOXM(1.8,1.6,1.3,.3),-1,s+.7,o+3.6,"steel")),e.push(P_(BOXM(.7,.7,1.1,.2),.8,s-1.5,o+1,"darkmetal")),void e.push(P_(BOXM(1.7,1.9,1.6,.3),-4.2,s+.9,o+4.6,"dark2"))):"long"===t?(e.push(P_(CYL(.42,8,7),1.4,s,o,"gunmetal",{ty:PI2})),e.push(P_(BOXM(2.4,1.2,1.4,.35),.1,s,o-.3,"wood")),e.push(P_(CYL(.34,2.2,6),3.2,s,o+1.1,"darkmetal",{ty:PI2})),e.push(P_(BOXM(.9,.9,1.5,.25),2.4,s,o-1.2,"darkmetal")),e.push(P_(CYL(.24,4.4,8),1.9,s-1.3,o+1.2,"dark2",{ty:PI2})),void e.push(P_(BOXM(.55,.9,1,.2),1.4,s,o-1.9,"dark2"))):"flamer"===t?(e.push(P_(CYL(.52,5.2,7),1.5,s,o,"gunmetal",{ty:PI2})),e.push(P_(CONE(.95,.45,1.6,7),6.5,s,o,"rust",{ty:PI2})),e.push(P_(CYL(.3,3,5),.4,s-1,o-1.2,"darkmetal")),e.push(P_(CYL(.35,.35,5),.4,s-1,o-2.4,"steel",{ty:PI2})),void e.push(P_(CYL(.35,.35,5),.4,s-1,o,"steel",{ty:PI2}))):(e.push(P_(CYL(.38,5.8,7),1.5,s,o,"gunmetal",{ty:PI2})),e.push(P_(BOXM(2.2,1.2,1.4,.35),.5,s,o-.4,"dark2")),e.push(P_(BOXM(.85,.85,1.6,.25),2.3,s,o-1.3,"darkmetal")),e.push(P_(BOXM(1.2,.9,.7,.25),.8,s,o+1,"darkmetal")),void e.push(P_(BOXM(.6,.55,1.4,.2),1,s+.35,o-.7,"dark2",{tx:-.15})))}function infantry(e,t){const r=1.26,n=[],a=(t=t||{}).cloth||"body",o=t.gear||"dark",s=[0,1,0,-1][3&e],i=1&e?.34:0,l=.55*s;return n.push(P_(BOXM(3.2,2.9,1.3,.6),1.6*s,-2,0,"dark2")),n.push(P_(BOXM(3.2,2.9,1.3,.6),-1.6*s,2,0,"dark2")),n.push(P_(CYL(1.35,.7,7),1.2*s,-2,1.3,"dark2")),n.push(P_(CYL(1.35,.7,7),-1.2*s,2,1.3,"dark2")),n.push(P_(CYL(1.3,3.6,7),1.2*s,-2,1.5,o)),n.push(P_(CYL(1.3,3.6,7),-1.2*s,2,1.5,o)),n.push(P_(CYL(1.42,.6,7),.8*s,-2,4.5,o)),n.push(P_(CYL(1.42,.6,7),-.8*s,2,4.5,o)),n.push(P_(CYL(1.55,2.4,7),.8*s,-2,4.7,a)),n.push(P_(CYL(1.55,2.4,7),-.8*s,2,4.7,a)),n.push(P_(BOXM(4.6,5.6,1.8,1),0,0,6.5+i,a)),n.push(P_(TSLAB(roundRectProfile(5,5.6,1.8,2),4.8,.9,"inftor"),0,0,6.8+i,a)),n.push(P_(BOXM(3.9,5.9,2.1,.5),.3,0,8.2+i,o)),n.push(P_(BOXM(.6,3,1,.18),2.1,0,8.6+i,"trim")),n.push(P_(BOXM(2.9,3,1.9,.6),-.3,-3.3,11+i,o,{r:-.18*s})),n.push(P_(BOXM(2.9,3,1.9,.6),-.3,3.3,11+i,o,{r:.18*s})),n.push(P_(DOME(1.15,1.1,8),1-l,-2.8,8+i,a)),n.push(P_(DOME(1.15,1.1,8),1+l,2.8,8+i,a)),n.push(P_(BOXM(2.9,4.8,4.2,1),-2.5,0,8.2+i,t.pack||o)),t.tank&&(n.push(P_(CYL(1.15,5,8),-2.6,-1.7,8.8+i,t.tank)),n.push(P_(CYL(1.15,5,8),-2.6,1.7,8.8+i,t.tank)),n.push(P_(DOME(1.15,.9,8),-2.6,-1.7,13.8+i,"steel")),n.push(P_(DOME(1.15,.9,8),-2.6,1.7,13.8+i,"steel"))),n.push(P_(CYL(1.05,3.9,7),1-l,-2.8,8.1+i,a)),n.push(P_(CYL(1.05,3.9,7),1+l,2.8,8.1+i,a)),n.push(P_(CYL(.9,1.6,6),1.6-l,-2.6,6.8+i,"skin")),n.push(P_(CYL(.9,1.6,6),1.6+l,2.6,6.8+i,"skin")),n.push(P_(CYL(1.3,1.8,8),0,0,12+i,"skin")),n.push(P_(DOME(2.35,2.15,11),-.1,0,14.6+i,t.helmet||"armor3")),n.push(P_(CYL(2.4,1.3,11),-.1,0,13.6+i,t.helmet||"armor3")),n.push(P_(BOXM(1.2,3.2,1.1,.3),1.4,0,14.4+i,t.visor||"glass",{e:1})),t.beret&&n.push(P_(CYL(2.45,.9,11),.2,0,15.6+i,t.beret)),t.hood&&n.push(P_(CONE(2.9,1,4.8,9),-.2,0,14.4+i,t.hood)),n.push(P_(BOXM(1.1,1.3,1.5,.3),.9,-1.5,9+i,"dark2")),n.push(P_(BOXM(1.1,1.3,1.5,.3),.9,1.5,9+i,"dark2")),n.push(P_(CYL(.3,4.2,6),-1.7,-.4,13.9+i,"darkmetal",{tx:-.3})),weaponRig(n,t.weapon||"rifle",i,s,a),n.map(e=>Object.assign({},e,{x:e.x*r,y:e.y*r,z:e.z*r,sx:(e.sx||1)*r,sy:(e.sy||1)*r,sz:(e.sz||1)*r}))}function jetBase(len,fac){const fr="soviet"===fac?1.5:3.1,fs="soviet"===fac?2:4;return[P_(TSLAB(roundRectProfile(1.05*len,6,fr,fs),4.6,.55,"fus"+len+fac),0,0,-2.3,"body"),P_(CONE(2.9,.5,.24*len,9),.4*len,0,0,"dark",{ty:PI2}),P_(DOME(2.7,2.4,11),.16*len,0,1.9,"glass",{e:1})]}
function kestrelModel(lit){const len=20,wid=14,n=jetBase(len,"allied");n.push(P_(SLAB(filletPoly([[.1*len,0],[-.08*len,.62*wid],[-.42*len,.62*wid],[-.46*len,0],[-.42*len,-.62*wid],[-.08*len,-.62*wid]],1.4,2),2,.55,"wgkes"),-.02*len,0,0,"body")),n.push(P_(WEDGE(.14*len,1.7,5.2,1.6),-.44*len,0,1.5,"dark",{r:.15})),n.push(P_(BOXM(.16*len,.6,1.4,.2),-.22*len,0,1.8,"trim"));for(const s of[.2*-wid,.2*wid])n.push(P_(CYL(1.7,.28*len,9),-.26*len,s,-1.4,"steel",{ty:-PI2})),n.push(P_(CYL(1.2,1.4,7),-.42*len,s,-1.4,lit?"glow":"rust",{ty:-PI2,e:lit?1:0}));for(const s of[.42*-wid,.42*wid])n.push(P_(CYL(.5,.2*len,7),.04*len,s,-2.6,"gunmetal",{ty:PI2})),n.push(P_(CONE(.5,.15,1.5,6),.14*len,s,-2.6,"black",{ty:PI2}));return n}
function jackalModel(lit){const len=21,wid=14,n=jetBase(len,"soviet");n.push(P_(SLAB(filletPoly([[.2*len,0],[-.02*len,.5*wid],[-.34*len,.3*wid],[-.4*len,0],[-.34*len,-.3*wid],[-.02*len,-.5*wid]],1.2,2),2,.55,"wgjak"),-.03*len,0,0,"body"));for(const s of[-1,1])n.push(P_(WEDGE(.13*len,1.5,4.6,1.5),-.4*len,s*.22*wid,1.5,"dark",{r:s*.28}));n.push(P_(BOXM(.14*len,1.6,1.3,.3),.28*len,0,-2.2,"dark2"));for(const s of[.2*-wid,.2*wid])n.push(P_(CYL(1.7,.28*len,9),-.26*len,s,-1.4,"steel",{ty:-PI2})),n.push(P_(CYL(1.2,1.4,7),-.42*len,s,-1.4,lit?"glow":"rust",{ty:-PI2,e:lit?1:0}));for(const s of[.4*-wid,.4*wid])n.push(P_(CYL(.5,.2*len,7),.04*len,s,-2.6,"gunmetal",{ty:PI2})),n.push(P_(CONE(.5,.15,1.5,6),.14*len,s,-2.6,"black",{ty:PI2}));return n}
function harrierModel(lit){const len=25,wid=19,n=jetBase(len,"allied");n.push(P_(SLAB(filletPoly([[.06*len,0],[-.1*len,.68*wid],[-.3*len,.6*wid],[-.36*len,0],[-.3*len,-.6*wid],[-.1*len,-.68*wid]],1.8,2),2.4,.55,"wghar"),-.04*len,0,0,"body")),n.push(P_(WEDGE(.16*len,2,6,1.9),-.36*len,0,1.7,"dark",{r:.13})),n.push(P_(BOXM(.18*len,.7,1.6,.22),-.18*len,0,2,"trim"));for(const s of[.2*-wid,.2*wid])n.push(P_(CYL(2.1,.32*len,10),-.28*len,s,-1.6,"steel",{ty:-PI2})),n.push(P_(CYL(1.5,1.6,8),-.46*len,s,-1.6,lit?"glow":"rust",{ty:-PI2,e:lit?1:0}));n.push(P_(CYL(1.6,.3*len,9),.02*len,0,-4.4,"gunmetal",{ty:PI2})),n.push(P_(DOME(1.6,1.2,8),.16*len,0,-4.4,"dark2",{ty:PI2}));for(const s of[.42*-wid,.42*wid])n.push(P_(CYL(1.2,.22*len,8),.06*len,s,-3.4,"white",{ty:PI2})),n.push(P_(CONE(1.3,.4,2.2,7),.2*len,s,-3.4,"red",{ty:PI2}));return n}
function eagleModel(lit){const len=27,wid=20,n=jetBase(len,"soviet");n.push(P_(SLAB(filletPoly([[.06*len,0],[-.1*len,.68*wid],[-.3*len,.6*wid],[-.36*len,0],[-.3*len,-.6*wid],[-.1*len,-.68*wid]],1.8,2),2.4,.55,"wgeag"),-.04*len,0,0,"body"));for(const s of[.24*-wid,.24*wid])n.push(P_(BOXM(.12*len,1.6,1.6,.25),.02*len,s,-1,"dark2"));for(const s of[.3*-wid,.3*wid])n.push(P_(CYL(.55,.5*len,8),-.3*len,s,-1.8,"darkmetal",{ty:-PI2})),n.push(P_(WEDGE(.1*len,1.4,4,1.4),-.42*len,s,1.2,"dark",{r:.16*(s<0?1:-1)}));n.push(P_(CYL(1.5,.28*len,9),.02*len,0,-4.2,"gunmetal",{ty:PI2}));for(const s of[.42*-wid,.42*wid])n.push(P_(CYL(1.2,.22*len,8),.06*len,s,-3.2,"white",{ty:PI2})),n.push(P_(CONE(1.3,.4,2.2,7),.2*len,s,-3.2,"red",{ty:PI2}));return n}function locustModel(t){const n=[],wa=13,wb=10,wc=8,wd=6.5,pulse=t?1.08:1;n.push(P_(DOME(.5,1,7),-11,0,0,"psi",{e:1})),n.push(P_(CONE(.35,2.6,6.5,10),-10.5,0,.2,"carapace2",{ty:PI2})),n.push(P_(CYL(2.6,5,10),-4,0,.2,"carapace2",{ty:PI2})),n.push(P_(CONE(2.6,1.3,4,10),1,0,.2,"carapace2",{ty:PI2})),n.push(P_(DOME(1.4,1.3,9),5.3,0,.3,"carapace")),n.push(P_(BOXM(.28,1.8,.5,.1),5.8,0,.6,"psi",{e:1})),n.push(P_(SLAB(filletPoly([[.18*wa,0],[.02*wa,.72*wb],[.14*-wa,.62*wb],[.1*-wa,0],[.14*-wa,.62*-wb],[.02*wa,.72*-wb]],.05*Math.min(wa,wb),2),1.2,.45,"locwgA"),-1,0,3,"glass",{sy:pulse})),n.push(P_(SLAB(filletPoly([[.18*wc,0],[.02*wc,.72*wd],[.14*-wc,.62*wd],[.1*-wc,0],[.14*-wc,.62*-wd],[.02*wc,.72*-wd]],.05*Math.min(wc,wd),2),1,.35,"locwgB"),-5.5,0,2.6,"glass",{sy:pulse})),n.push(P_(DOME(.9,.8,7),-1.5,0,-2.3,"psi",{e:1}));return n}function restorerModel(t){const e=[],s=3.4;wheelUnit(e,26,13,6.5,t);e.push(P_(SLAB(hullProfile(.9*26,14.5,"allied"),5,1.6,"resA"),0,0,s,"body"));const hTop=s+5;e.push(P_(BOXM(8,10.5,3.6,.6),-2,0,hTop,"armor2"));e.push(P_(BOXM(4,7,2,.3),-5.5,0,hTop+3.6,"glass",{e:1}));e.push(P_(CYL(1.3,2.2,8),6,0,hTop,"darkmetal"));const armBase=hTop+2.2,armMidZ=armBase+4.8,armEndZ=armBase+.3;strut3(e,6,0,armBase,11,3,armMidZ,.8,"gunmetal");strut3(e,11,3,armMidZ,15,3,armEndZ,.6,"steel");const gx=13,gy=3,gz=(armMidZ+armEndZ)/2;e.push(P_(CYL(1,1.3,8),gx,gy,gz-.65,"tesla",{e:1}));e.push(P_(CYL(.5,.6,6),9,-5.5,hTop,"lightY",{e:1}));e.push(P_(CYL(.5,.6,6),9,5.5,hTop,"lightY",{e:1}));return e}function salvagerModel(t){const e=[],s=4.2;trackUnit(e,30,15,8,t,{wheels:6,trkW:7.5});e.push(P_(SLAB(hullProfile(.94*30,16.5,"soviet"),7,1.8,"salvS"),0,0,s,"body"));const hTop=s+7;e.push(P_(BOXM(8,11,3.6,.7),-4,0,hTop,"dark2"));e.push(P_(BOXM(5,7,1.8,.3),-6.5,0,hTop+3.6,"glassdark"));e.push(P_(CYL(1.4,2.4,8),5,0,hTop,"gunmetal"));const armBase=hTop+2.4,armMidZ=armBase+4.4,armEndZ=armBase+.2;strut3(e,5,0,armBase,9,2.5,armMidZ,.85,"rust");strut3(e,9,2.5,armMidZ,12,2.5,armEndZ,.6,"darkmetal");const gx=10.5,gy=2.5,gz=(armMidZ+armEndZ)/2;e.push(P_(CYL(1,1.3,7),gx,gy,gz-.65,"glow",{e:1}));for(const sgn of[-1,1])e.push(P_(CYL(.5,3,6),-9,sgn*3,hTop,"rust"));e.push(P_(CYL(.5,.6,6),7,-5.5,hTop,"lightY",{e:1}));e.push(P_(CYL(.5,.6,6),7,5.5,hTop,"lightY",{e:1}));return e}function cultivatorModel(t){const e=[],s=4.42;legWalker(e,26,14,8.5,t,6);e.push(P_(SLAB(hullProfile(.94*26,15.5,"yuri"),7,1.8,"cultY"),0,0,s,"body"));const hTop=s+7;e.push(P_(DOME(7,5,12),0,0,hTop,"carapace"));e.push(P_(DOME(3.5,3,10),0,0,hTop+3,"bile",{e:1}));for(let i=0;i<4;i++){const ang=i*PI2+.5,bz=hTop+2.5,tx=9*Math.cos(ang),ty=9*Math.sin(ang),tz=1.5;strut3(e,0,0,bz,tx,ty,tz,.5,"carapace2");e.push(P_(CYL(.7,.9,6),tx,ty,tz-.45,"psi",{e:1}))}return e}function scaleN(e,f){return e.map(p=>Object.assign({},p,{x:f*(p.x||0),y:f*(p.y||0),z:f*(p.z||0),sx:f*(p.sx||1),sy:f*(p.sy||1),sz:f*(p.sz||1)}))}function scale2(e){return scaleN(e,2)}
...
const bw=.8*r,bd=.5*r,bh=.24*r,hw=bw/2,hd=bd/2,doorW=.7*r,doorH=.9*bh,doorY=hd+.3,z2=l+bh;
...
const facMat=a?{body:"armor",trim:"armor3",accent:"glow",frame:"gunmetal",dark:"dark2"}
  ...
  :{body:"carapace2",trim:"bone",accent:"psi",frame:"flesh",dark:"dark2"};
...
n.push(P_(WALLONLY(roundRectProfile(bw,bd,.1*Math.min(bw,bd),3),bh,.995,"favW"),0,0,l,facMat.body));
...
n.push(P_(BOXM(doorW,3.2,doorH,.1),0,doorY-.4,l,facMat.dark));
...
const reveal=clamp((dt2-.15)/.5,0,1);
if(prod&&UNITS[prod]&&reveal>.02)try{
...
const pu=UMODEL_(prod,0,{fac:t}),scale=.78*reveal,ang=Math.PI/2,cs=Math.cos(ang),sn=Math.sin(ang),py=doorY+4;
for(const p of pu){
