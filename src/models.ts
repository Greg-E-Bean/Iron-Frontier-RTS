...
if(o||a){
n.push(P_(TSLAB(roundRectProfile(bw,bd,.1*Math.min(bw,bd),3),bh,.995,"favW"),0,0,l,facMat.body));
n.push(P_(BOXM(bw*1.06,bd*1.06,1.1,.35),0,0,l+.05,"concrete2"));
// `roof` and `concrete2` are matte (non-metal GL bucket) - a big continuous
