...
e.push(P_(BOXM(10,8.4,7,1),-15,0,10,"dark2",{r:-.1}));
e.push(P_(BOXM(3,8.6,7.4,.8),13.5,0,10,"body"));
e.push(P_(DOME(5,4,9),14.5,0,11.5,"glass",{e:1}));
e.push(P_(BOXM(1.6,9,1,.2),-28,0,11.6,"dark"));
e.push(P_(CYL(.8,6,8),2,0,16,"gunmetal"));
e.push(P_(CYL(.8,6,8),-28,0,16,"gunmetal"));
for(const s of[-1,1])e.push(P_(CYL(.6,3.5,6),4,6*s,4,"gunmetal"));
return e;
}
...
e.push(P_(BOXM(2,9,1,.2),-24,0,11.6,"dark"));
e.push(P_(CYL(1.2,6,8),1,0,15,"gunmetal",{ty:-PI2,e:0}));
e.push(P_(CYL(.8,4,6),-24,0,12,"gunmetal",{ty:-PI2}));
...
e.push(P_(DOME(1,.8,8),-17.5,0,10,"psi",{e:1}));
