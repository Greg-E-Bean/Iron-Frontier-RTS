...
if(pk&&riseBucket>=4)for(const sx of[-1,1]){const bx=sx*(doorW/2-3.5),by=doorY+3,sw={orbit:2.3+.4*sx,amp:.45,pvx:bx,pvy:by};n.push(P_(CYL(1.8,2.2,10),bx,by,l,"darkmetal"));strut3(n,bx,by,l+2.2,bx-sx*4,by+2,l+11,.8,"lightY");n[n.length-1].a=sw;strut3(n,bx-sx*4,by+2,l+11,bx-sx*7,by+5,l+7,.6,"steel");n[n.length-1].a=sw;n.push(P_(DOME(.9,.9,8),bx-sx*7,by+5,l+6.6,"tesla",{e:1,a:sw}))}
