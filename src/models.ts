...
function juggernautHull(t){const p=tankHull(64,30,t,{wheels:8,skirt:!0,th:13,trkW:12,fac:"soviet"});
...
a.push(P_(SLAB(turretProfile(TL,TW,"soviet"),7,2.2,"jugT"),tx,0,z,"body"));
a.push(P_(SLAB(turretProfile(.7*TL,.72*TW,"soviet"),1.6,.7,"jugT2"),tx-.12*TL,0,z+7,"armor2"));
...
function crane(e,cx,cy,z,h,arm,mat){if("yuri"===_bFac)return organicCrane(e,cx,cy,z,h,arm);
mat=mat||"gunmetal";
...
function empSpireModel(r,l){const n=[];n.push(P_(CYL(.3*r,3,16),0,0,l,"concrete2"));for(let k=0;k<4;k++){const a=k*1.571+.78,x=Math.cos(a)*.26*r,y=Math.sin(a)*.26*r;n.push(P_(BOXM(5,5,7,.4),x,y,l+3,"armor3")),n.push(P_(CYL(1.2,3,8),x,y,l+10,"tesla",{e:1})),strut3(n,x,y,l+3,0,0,l+44,.6,"darkmetal")}n.push(P_(CYL(4,40,12),0,0,l+3,"darkmetal"));for(let k=0;k<5;k++)n.push(P_(CYL(7.5-.8*k,1.4,16),0,0,l+10+7*k,"tesla",{e:1,a:{bob:1.2+.25*k,ba:.8}}));n.push(P_(CYL(5,3,14),0,0,l+43,"steel")),n.push(P_(DOME(4.6,4,14),0,0,l+46,"crystal",{e:1})),n.push(P_(BOXM(12,.6,.6,.1),0,0,l+48,"tesla",{e:1,a:{spin:2.4}})),n.push(P_(BOXM(.6,12,.6,.1),0,0,l+48,"tesla",{e:1,a:{spin:2.4}}));return n}
...
function depositBay(n,t){const A="allied"===t,O="soviet"===t,y=64,w=40,d=32,z=3.5;
...
const foundH=(e,t)=>FOUNDED[e]?("yuri"===t?1.4:"soviet"===t?2.4:2):0;
function bldFoundation(n,e,t,r){const H=foundH(e,t);if(!H)return;const W=.94*r,z0=2.2,top=3.6+H,A="allied"===t,O="soviet"===t,k=r+"_"+H;
...
for(const sx of[-1,1])for(const sy of[-1,1])n.push(P_(BOXM(6,.4,.45,.1),sx*(h-6),sy*(h+2.3),z0+1,"tesla",{e:1}));
...
let _bFac:any=null;function BMODEL_(e,t,dep,cn,rot,prod,doorT=0){cn=cn||0;_bFac=t;const r=32*BLD[e].size,n=[],a="allied"===t,o="soviet"===t,d=!1!==dep;const s=.3*r,i=.24*r,l=3.6+foundH(e,t),c=l+s;bldFoundation(n,e,t,r);
...
if("orerig"===e)return oreRigModel(t||"allied",l);if(CIVX[e])return CIVX[e](r,l,t);switch(e){case"triturret":{const fac=a?"allied":o?"soviet":"yuri",mat=a?"armor":o?"concrete2":"carapace",accent=a?"armor3":o?"rust":"carapace2",plw=.92*r,pld=.62*r,ph=.14*r,rs=16,taper=.92;
...
if(riseBucket>=2){for(const sx of[-5.5,0,5.5])n.push(P_(BOXM(3.6,.5,2.4,.1),sx,6.6,l+3.4,"glass",{e:1}));acUnit(n,-5,-2,l+8.8,5,4,0);n.push(P_(CYL(.3,7,6),6,-3,l+8.8,"darkmetal"));n.push(P_(DOME(.8,.8,8),6,-3,l+15.8,"tesla",{e:1}));}
...
function UMODEL(e,t,extra){const fac=extra&&"object"==typeof extra?extra.fac:void 0,_a=getAssetModel(e,fac);if(_a)return _a;const um=vehAccent(UMODEL_(e,t||0,extra),e,extra);return UNITS[e]&&(UNITS[e].fly||NO_ATTACH[e])?um:attachFloating(um,"yuri"===fac?"carapace2":"darkmetal")}const NO_ATTACH:Record<string,1>={drone:1,terror:1,rocketeer:1,hivetrans:1};function UTURRET(e,t,extra?){return UTURRET_(e,t||0,extra)}const YREMAP:Record<string,string>={steel:"bone",metal:"carapace",darkmetal:"carapace2",gunmetal:"carapace2",concrete:"carapace",concrete2:"carapace2",rust:"flesh",armor:"carapace",armor2:"carapace",armor3:"carapace2",lightY:"psi",glass:"psi",glassdark:"carapace2",roof:"carapace2",tread:"carapace2",rubber:"flesh",wood:"bone",olive:"carapace2",red:"flesh",tesla:"psi",glow:"psi",crystal:"psi",white:"bone",nose:"carapace",gold:"bile"};const YDRESS_SKIP:Record<string,number>={wall:1,gate:1};
...
function BMODEL(e,t,d,cn,rot,prod=null,doorT=0){const _a=getAssetModel(e,t);if(_a)return"yuri"===t?yuriDress(_a,e):_a;const m=BMODEL_(e,t,d,cn,rot,prod,doorT);const g=groundModel("yuri"===t?yuriDress(m,e):m);return"refinery"===e?g:attachFloating(g,"yuri"===t?"carapace2":"darkmetal")}function BTURRET(e,t,r){const m=BTURRET_(e,t,r||0);return m&&m.length?m.map(q=>q?Object.assign({},q,{z:(q.z||0)-GROUND_DROP}):q):m}
/*
