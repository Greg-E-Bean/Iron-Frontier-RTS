...
function jetNozzle(n,x,y,z,r,lit,glow){n.push(P_(CYL(r,1.8,12),x,y,z,"gunmetal",{ty:-PI2}));n.push(P_(CYL(.8*r,.4,12),x-1.8,y,z,"black",{ty:-PI2}));n.push(P_(CONE(.75*r,.1,lit?5:3.2,10),x-1.9,y,z,glow,{e:1,ty:-PI2}))}
