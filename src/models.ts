...
return p}
function juggernautTurret(){const a=[],z=JUG_Z,T=JUG_T,P2=PI2;
a.push(P_(CYL(.95*T,2.6,14),0,0,z-2.4,"dark"));
a.push(P_(SLAB(turretProfile(2.1*T,1.75*T,"soviet"),8.5,2.6,"jugT"),-.08*T,0,z,"body"));
a.push(P_(SLAB(turretProfile(1.5*T,1.25*T,"soviet"),1.8,.8,"jugT2"),-.25*T,0,z+8.5,"armor2"));
a.push(P_(BOXM(6,1.5*T,8,1.4),1.05*T,0,z+.6,"gunmetal"));
for(const sy of[-6,6]){const bz=z+4.6;
a.push(P_(CYL(3.2,9,12),1.05*T+2,sy,bz,"darkmetal",{ty:P2,b:1}));
a.push(P_(CYL(2.1,40,12),1.05*T+2,sy,bz,"gunmetal",{ty:P2,b:1}));
for(const f of[.35,.62])a.push(P_(CYL(2.5,3,12),1.05*T+2+40*f,sy,bz,"armor3",{ty:P2,b:1}));
a.push(P_(CYL(3,6,12),1.05*T+2+36,sy,bz,"steel",{ty:P2,b:1}));
a.push(P_(BOXM(2,7.4,6.4,.4),1.05*T+2+41,sy,bz-3.2,"gunmetal",{b:1}))}
for(const sy of[-1,1]){const px=-.12*T,py=sy*(1.02*T+4.2),pz=z+1.2;
a.push(P_(BOXM(4,4,5,.6),px,sy*(1.02*T+.6),pz+1,"darkmetal"));
a.push(P_(BOXM(15,7.4,8.2,1),px,py,pz,"body"));
a.push(P_(BOXM(15.4,7.8,1,.3),px,py,pz+8.2,"rust"));
for(const oy of[-1.8,1.8])for(const oz of[2,5.2])a.push(P_(CYL(1.25,.9,8),px+7.2,py+oy,pz+oz,"dark2",{ty:P2})),a.push(P_(CYL(.8,.5,8),px+7.9,py+oy,pz+oz,"red",{ty:P2,e:1}))}
a.push(P_(CYL(2.6,2.2,10),-.45*T,-.5*T,z+10.3,"darkmetal"));a.push(P_(DOME(2.2,1.4,10),-.45*T,-.5*T,z+12.5,"gunmetal"));
for(const k of[-1,1])a.push(P_(BOXM(1.4,1.2,1.2,.2),-.45*T+2.2,-.5*T+k*1.4,z+11.6,"glassdark",{e:1}));
a.push(P_(CYL(.3,9,5),-.8*T,.55*T,z+10.3,"darkmetal"));
for(const k of[-1,1])for(let q=0;q<3;q++)a.push(P_(CYL(.7,2.2,6),.3*T-2*q,k*.86*T,z+8.2,"dark2",{ty:-.9}));
return a}
