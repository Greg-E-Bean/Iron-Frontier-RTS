...
function oilDerrickModel(r,l){const n=[];ell(n,4,6,l-.2,9,7,.3,"black");const px=-6,pb={bob:1.4,ba:3};n.push(P_(BOXM(4,4,1.4,.3),px,0,l,"concrete2")),n.push(P_(BOXM(2.2,3.6,13,.3),px,0,l+1.4,"darkmetal"));n.push(P_(BOXM(26,2,2.2,.3),px,0,l+14,"#c9a227",{a:pb})),n.push(P_(BOXM(4.4,3.2,7,.4),px+13,0,l+10,"#c9a227",{a:pb})),n.push(P_(CYL(.3,11,6),px+14.5,0,l+1,"steel",{a:{bob:1.4,ba:2.2}})),n.push(P_(BOXM(5,5,5,.5),px-12,0,l+11,"darkmetal",{a:pb})),n.push(P_(BOXM(7,5,5,.6),px-9,0,l,"armor3")),n.push(P_(CYL(2.4,1,10),px-9,-3,l+2.4,"darkmetal",{tx:Math.PI/2,a:{spin:3}}));n.push(P_(CYL(2,3,10),px+14.5,0,l,"darkmetal"));n.push(P_(CYL(9,14,18),14,-12,l,"#b6ae9c")),n.push(P_(DOME(9,2.4,18),14,-12,l+14,"#9c9484")),n.push(P_(BOXM(.6,18.2,.5,.1),14,-12,l+7,"red",{r:.8}));for(let k=0;k<4;k++)n.push(P_(BOXM(.4,.4,14,.1),14+9*Math.cos(k*1.57),-12+9*Math.sin(k*1.57),l,"darkmetal"));n.push(P_(CYL(.7,20,8),px+14.5,1,l+2,"steel",{ty:1.2,r:-.9}));pipeRun(n,px+14.5,1,14,-3,l+1.4,.7,"steel");n.push(P_(BOXM(8,5,6,.4),-16,14,l,"concrete")),n.push(P_(WEDGE(8,5,.3,2.4),-16,14,l+6,"rust")),n.push(P_(BOXM(1.6,.4,2.4,.1),-16,16.6,l+2,"glassdark"));for(let k=0;k<3;k++)barrel(n,-4+3*k,16,l);return n}
...
function BMODEL(e,t,d,cn,rot,prod=null,doorT=0){const _a=getAssetModel(e,t);if(_a)return"yuri"===t?yuriDress(_a,e):_a;const m=BMODEL_(e,t,d,cn,rot,prod,doorT);return groundModel("yuri"===t?yuriDress(m,e):m)}function BTURRET(e,t,r){const m=BTURRET_(e,t,r||0);return m&&m.length?m.map(q=>q?Object.assign({},q,{z:(q.z||0)-GROUND_DROP}):q):m}
/*
