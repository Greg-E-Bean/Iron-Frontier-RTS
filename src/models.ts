...
if("orerig"===e)return oreRigModel(t||"allied",l);switch(e){case"triturret":{const fac=a?"allied":o?"soviet":"yuri",mat=a?"armor":o?"concrete2":"carapace",accent=a?"armor3":o?"rust":"carapace2",plw=.92*r,pld=.62*r,ph=.14*r,rs=16,taper=.92;
