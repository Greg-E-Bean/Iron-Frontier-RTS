...
return e}
function crystalModel(e,t,v){v=v||0;const r=[],gem=2===e,cG=gem?"tibB":"tibG",cL=gem?"tibBlit":"tibGlit",frac=(t+1)/6,H=(k)=>{const x=Math.sin(12.9898*k+78.233*(v+1)+e*7.7)*43758.5453;return x-Math.floor(x)};
...
function PROPMODEL(e,t){const _a=getAssetModel(e);if(_a)return _a;return"tree"===e?treeModel(t):"grass"===e?grassModel(t):"flower"===e?flowerModel(t):"rock"===e?rockModel(t):"scrub"===e?scrubModel(t):"lamp"===e?lampModel():"fall"===e?fallModel(t):"tower"===e?towerModel(t):"crater"===e?craterModel(t):"wreck"===e?wreckModel(t):"rubble"===e?rubbleModel(t):"bridge"===e?bridgeModel(t):"monument"===e?monumentModel(t):"stall"===e?stallModel(t):stoneModel(t)}
