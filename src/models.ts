...
else if(1===e||5===e){const big=1===e,H=big?34:22;trunk(H*.9,big?2.2:1.6,.7,0);const n=big?6:4;for(let k=0;k<n;k++){const f=k/(n-1),r=(big?12.5:9)*(1-.72*f)+1,z=(big?7:5)+f*(H-8),ox=(R(k)-.5)*1.2,oy=(R(k+5)-.5)*1.2;t.push(P_(CONE(r*1.04,r*.8,1.6,11),ox,oy,z-1.2,"green2"));t.push(P_(CONE(r,r*.22,big?8:6.5,11),ox,oy,z,"pine"))}t.push(P_(CONE(big?2.6:2,.2,big?6:4.5,8),0,0,H-1,"pine"))}
