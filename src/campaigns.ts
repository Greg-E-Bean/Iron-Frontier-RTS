...
{name:"Ghost Protocol",map:"dust",briefing:"No army this time — just Tanya, dropped alone behind enemy lines. Take down their Construction Yard before they know she's there and their war effort collapses on its own. First-person or third-person, her call — press V to switch views.",diffs:["easy"],objective:{type:"destroyTarget",key:"conyard"},hero:!0}
