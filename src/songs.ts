...
const MUSIC_SONGS = [
  ...
  },
  {
    ...
    form: [
      ...
      { bars: 4, r: "C", d: "pulse", pd: "P" },
      { bars: 4, r: "A", d: "half" },
      { bars: 4, r: "B", l: "A", synth: true, d: "rock", pd: "P" },
      { bars: 4, r: "A", d: "groove" },
      { bars: 4, r: "B", l: "A", synth: true, d: "rock", st: "H" },
      { bars: 4, r: "C", l: "B", synth: true, d: "pulse", pd: "P" },
  ...
  },
  {
    ...
    form: [
      ...
      { bars: 4, r: "A", d: "half" },
      { bars: 4, r: "B", l: "A", d: "half" },
      { bars: 4, r: "C", d: "groove" },
      { bars: 4, r: "A", l: "A", d: "half", st: "H" },
      { bars: 4, r: "B", l: "B", d: "groove" },
      { bars: 4, r: "C", d: "drive" },
      { bars: 4, r: "A", l: "B", d: "half", st: "H" },
    ],
  },
  {
  ...
  },
  {
    ...
    form: [
      { bars: 4, pd: "P", d: "pulse" },
      { bars: 4, r: "A", g: "mute", d: "light", pd: "P" },
      { bars: 4, r: "A", g: "mute", l: "A", synth: true, d: "rock" },
      { bars: 4, r: "B", l: "B", d: "rock", pd: "P" },
      { bars: 4, r: "A", g: "mute", l: "A", synth: true, d: "ride" },
      { bars: 4, r: "B", l: "B", d: "drive" },
      { bars: 4, r: "A", g: "clean", pd: "P", d: "light" },
      { bars: 4, r: "B", l: "A", d: "rock", pd: "P" },
      { bars: 4, pd: "P", d: "none" },
    ],
  },
  {
    ...
    form: [
      ...
      { bars: 4, r: "A", g: "clean", d: "none", pd: "P" },
      { bars: 4, r: "A", g: "clean", d: "light", l: "A" },
      { bars: 4, r: "B", l: "B", d: "half", pd: "P" },
      { bars: 4, r: "A", g: "clean", d: "ride", l: "A" },
  ...
  },
  {
    ...
    form: [
      { bars: 4, r: "A", g: "clean", d: "none" },
      { bars: 4, r: "A", g: "clean", d: "light", l: "A" },
      { bars: 4, r: "B", d: "half", l: "B", pd: "P" },
      { bars: 4, r: "A", g: "clean", d: "ride", l: "A", pd: "P" },
      { bars: 4, r: "B", d: "rock", l: "B", pd: "P" },
      { bars: 4, r: "B", d: "half", l: "A" },
      { bars: 4, r: "A", g: "clean", d: "none", pd: "P" },
    ],
  },
  ...
  //  chants: 1/8 units at sung pitch, n = notes, v = one syllable per note.
  {
    ...
    parts: {
      riffs: {
        A: ".D.D.D.D D4 .D.D.D.D F2E2 | .D.D.D.D D4 .D.D.D.D A2G2 | ._B,._B,._B,._B, _B,4 ._B,._B,._B,._B, C2D2 | .C.C.C.C C4 .A,.A,.A,.A, A,4 |",
